      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <Link href="/map" className="text-white/70 hover:text-white transition-colors">Map</Link>
        ...
        {open && (
          <div className="md:hidden py-4 border-t border-white/10 flex flex-col gap-4 text-sm font-medium">
            ...
            <Link href="/map" className="text-white/70 hover:text-white transition-colors" onClick={() => setOpen(false)}>Map</Link>
